...
import KajalKohl from './KajalKohl'
...
export default function Eyes() {
    ...
    const filterProducts = () => {
      ...
      const changecategrory2 = (event) => {
        const LipLin = document.getElementById('all-categrories-in-one-div201');
        const LiqLip = document.getElementById('all-categrories-in-one-div202');
        const LipBal = document.getElementById('all-categrories-in-one-div203');
        const Gloss = document.getElementById('all-categrories-in-one-div204');
        const showheading = document.getElementById('show-categrory-heading02');
        ...
        switch (event.target.value) {
          case 'option1':
            ...
            showheading.innerText='EYE LINERS'
            break;
          ...
          case 'option2':
            ...
            LipBal.style.display = 'none';
            Gloss.style.display = 'none';
            showheading.innerText='KAJAL & KOHL'          
            break;
          ...
          case 'option4':
            ...
            showheading.innerText='EYE SHADOW'
            break;
  ...
  return (
    <div>
        ...
        <div className='lips-gallery'><img src="./Eyes images/Eyes banner image.webp" alt="Eyes-page-Banner-photo" /></div>


                                    {/* heading which categrory is choosen */}

        <div id='categrory-heading' className='categrory-heading'>
            <h1 id='show-categrory-heading02' className='show-categrory-heading'>EYE LINERS</h1>
        </div>
    ...
    <div style={{display:'flex',margin:'20px 0px 0px 0px'}}>
                ...
                <div id='dropdown-content'className='dropdown-content'>
                    <div class="radio-buttons">
                        <label class="radio-button">
                            ...
                            <span class="radio-label">Eye Liners</span>
                        </label>
                        <label class="radio-button">
                            <input type="radio" name="option" value="option2"  onClick={(e) => changecategrory2(e, true)}/>
                            <div class="radio-circle"></div>
                            <span class="radio-label">Kajal & Khol</span>
                        </label>
                        <label class="radio-button">
                            <input type="radio" name="option" value="option3" onClick={(e) => changecategrory2(e, true)}/>
                            <div class="radio-circle"></div>
                            <span class="radio-label">Mascara</span>
                        </label>
                        <label class="radio-button">
                            <input type="radio" name="option" value="option4" onClick={(e) => changecategrory2(e, true)}/>
                            <div class="radio-circle"></div>
                            <span class="radio-label">Eye Shadow</span>
                        </label>
                    </div>
                </div>
            </div>
        ...
        <div style={{width:'940px',margin:'0px 0px 0px 390px'}} className='all-categrories-in-one-div2' id='all-categrories-in-one-div2'>

            <div id='all-categrories-in-one-div201' >
                <EyeLiner/>
            </div>

            <div id='all-categrories-in-one-div202' style={{display:'none'}} >
                <KajalKohl/>
            </div>

            <div id='all-categrories-in-one-div203' style={{display:'none'}}>
                <Mascara/>
            </div>

            <div id='all-categrories-in-one-div204' style={{display:'none'}}>
                <EyeShadow/>
            </div>
    ...
    <div style={{margin:'1450px 0px 0px 0px'}}><SubFooter/></div>  
    </div>
  )
}