...
const Gloss = () => {
  ...
  function svgimage104(id,contentId) {
  ...
  return (
    <div>
      <div className="product-list">
        {/* Product 1 */}
        <div className="product-card" id="content-10401" >
          <Link to='/productdetails'><img src="./Lips images/Gloss/Gloss 01.webp" alt="Matte Lipstick" width="100%" onClick={() => productDetails('content-10401')}/></Link> 
          <p className='rating'>&#11088; 5</p>
          <p className="product-name">Lakmē absolute pulmp and shine lip gloss</p>
          <p className="product-price">680</p>
          <button className="button type1" onClick={() => clicktoadd('content-10401')}>ADD TO BAG</button>
          <div className="svg-container" onClick={() => svgimage104('svgimg104-1','content-10401')}>
            <svg id="svgimg104-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="40" height="35" fill="grey" stroke="white" strokeWidth="1">
